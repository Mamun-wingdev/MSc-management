...
.fade-carousel .slides .slide-1 {
  background-image: url(14th-Graduation-Ceremony-01-1024x607.jpg) ;
}
.fade-carousel .slides .slide-2 {
...
<h2 style="text-align:center; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">MIST POSTGRADUATE SYSTEM</h2>

<div class="row" >
<div class="col-lg-5" style="height:auto">

 <a class="btn btn-block" href="z1.php" style="margin-bottom:10px; font-size:20px ;background: hsla(0,2%,26%,1.00) ; color:hsla(0,27%,98%,1.00) "><strong>Home</strong></a>
    <a class="btn btn-block " href="Admission1.php" style="margin-bottom:10px ;font-size:20px;background:hsla(0,2%,26%,1.00) ;color:hsla(0,27%,98%,1.00) "><strong>Admission</strong></a>
    <a class="btn btn-block " href="z4.php" style="margin-bottom:10px ;font-size:20px;background: hsla(0,2%,26%,1.00) ;color:hsla(0,27%,98%,1.00) "><strong>Student Profile</strong></a>
    <a class="btn btn-block" href="Z3.php" style="margin-bottom:10px ;font-size:20px;background: hsla(0,2%,26%,1.00) ;color:hsla(0,27%,98%,1.00) "><strong>Teachers Profile</strong></a>
    <a class="btn btn-block " href="z4.php" style="margin-bottom:10px ;font-size:20px;background: hsla(0,2%,26%,1.00) ;color:hsla(0,27%,98%,1.00) "><strong>Department</strong></a>
      <a class="btn btn-block" href="z5.php" style="margin-bottom:10px ;font-size:20px;background: hsla(0,2%,26%,1.00) ;color:hsla(0,27%,98%,1.00) "><strong>Authority </strong></a>
      
   <h2 style="text-align:center; font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif">Welcome to MIST</h2> 
