...
?>
<?php
$query= "SELECT viva.name AS sname, viva.nid AS sid,eaxmmarks.written+viva.viva AS TOTAL_MARKS FROM eaxmmarks INNER JOIN viva ON eaxmmarks.nid = viva.nid ORDER BY eaxmmarks.written+viva.viva DESC LIMIT 30";             
...
<div class="container" style="position:relative; top:80px;">
    <h3 style="text-align:center; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">FINAL RESULT</h3>
    <hr>
