...
if(isset($_POST['sub'])){      
		...
		$insert= mysqli_query($connection,"INSERT INTO eaxmmarks (name,nid,written) VALUES ('$name','$nid','$wmarks')");
			...
			<div class="row main">
				<div class="panel-heading">
	               <div class="panel-title text-center">
	               		<h1 class="title">Written exam marks fillup</h1>
	               		<hr />
	               	</div>
	            </div> 
				<div class="main-login main-center">
<form class="form-horizontal" action="written.php" onsubmit="return checkEmail()" method="post" >
